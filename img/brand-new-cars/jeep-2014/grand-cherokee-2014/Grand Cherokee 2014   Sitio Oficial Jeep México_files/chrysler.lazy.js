var lazyLoader = new function()
{
	...
	this.blankImage = "../img/interior/loading-bar.gif";
	...
	this.showPreloader = function(element)
	{
		if (element.tagName == "IMG")
		{
			...
			element.setAttribute("_alt", element.getAttribute("alt"));
		...
		if (lazyElement.tagName == "IMG")
		{
			functionCall = function(lazyImage)
			{
				lazyImage.onload = lazyImage.onabort = lazyImage.onerror = function()
				{
					...
					lazyImage.setAttribute("alt", lazyImage.getAttribute("_alt"));
					lazyImage.removeAttribute("_alt");
